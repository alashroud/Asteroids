...
AFRAME.registerComponent('shield', {
  ...
  createExplosion: function() {
    ...
    ring.setAttribute('animation', {
      ...
      from: this.data.radius,
      to: this.data.radius * 3,
      dur: 600,
      easing: 'easeOutQuad'
    });
    ...
    ring.setAttribute('animation__tube', {
      property: 'geometry.radiusTubular',
      from: 0.3,
      to: 0.05,
      dur: 600,
      easing: 'easeOutQuad'
    ...
    // Create explosion particles (50 fragments)
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      // Varied colors (cyan to white spectrum)
      ...
      // Calculate random direction in 3D space
      ...
      // Particle animations (fly outward, shrink, fade)
