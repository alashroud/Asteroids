export class DifficultyManager {
  ...
  reset() {
    ...
    // Configurable curves
    this.config = {
      baseSpawnInterval: 2500, // Starting spawn rate (ms)
      minSpawnInterval: 600,   // Fastest possible spawn rate (ms)
      baseEnemySpeed: 1.0,     // Starting enemy speed
      speedIncrement: 0.1,     // Speed increase per level
      intervalDecrement: 50,   // Spawn rate decrease (ms) per level
